...
const WEEKS = [
  {
    ...
    days: [
      { day: "Mon", exercise: "Squats 4×10 + Hip Thrusts 3×12", focus: "Testosterone trigger", foods: ["Watermelon (incl. white rind, blended)", "Spinach / Arugula"] },
      { day: "Tue", exercise: "Cardio 20 min (brisk walk/jog)", focus: "Blood flow / NO production", foods: ["Beets / Beet juice", "Walnuts"] },
      { day: "Wed", exercise: "Push-ups 4×15 + Deadlifts (light)", focus: "Full body hormone boost", foods: ["Dark chocolate 85%+", "Watermelon (incl. white rind, blended)"] },
      { day: "Thu", exercise: "Rest / Yoga / Stretching", focus: "Cortisol reduction", foods: ["Spinach / Arugula", "Walnuts"] },
      { day: "Fri", exercise: "Squats 4×12 + Lunges 3×10", focus: "Pelvic floor activation", foods: ["Beets / Beet juice", "Dark chocolate 85%+"] },
      { day: "Sat", exercise: "Kegel exercises 3×20 reps", focus: "Erection control", foods: ["Watermelon (incl. white rind, blended)", "Walnuts"] },
  ...
  },
  {
    ...
    days: [
      { day: "Mon", exercise: "Bulgarian split squats 4×8 each leg", focus: "Glute/hip chain", foods: ["Watermelon (incl. white rind, blended)", "Pomegranate juice (30ml)"] },
  ...
  },
  {
    ...
    days: [
      { day: "Mon", exercise: "Squats 5×10 + Hip Thrusts 4×12", focus: "Testosterone trigger (+20%)", foods: ["Watermelon (incl. white rind, blended)", "Ginger (fresh/tea)"] },
      { day: "Tue", exercise: "Cardio 25 min + sprints 3×30s", focus: "Enhanced blood flow", foods: ["Hemp seeds", "Cayenne pepper"] },
      { day: "Wed", exercise: "Push-ups 5×15 + Deadlifts", focus: "Full body hormone surge", foods: ["Fenugreek (in smoothie)", "Saffron (pinch in food)"] },
      { day: "Thu", exercise: "Rest / Yoga / Stretching", focus: "Cortisol management", foods: ["Ginger (fresh/tea)", "Hemp seeds"] },
      { day: "Fri", exercise: "Squats 5×12 + Lunges 4×10", focus: "Pelvic activation", foods: ["Watermelon (incl. white rind, blended)", "Saffron (pinch in food)"] },
      { day: "Sat", exercise: "Kegel exercises 4×20 reps", focus: "Erection strength", foods: ["Cayenne pepper", "Fenugreek (in smoothie)"] },
